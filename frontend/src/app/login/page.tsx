...
import { LogIn, Mail, Lock, AlertCircle, ArrowRight, User, X, Info, Settings, Key, HelpCircle, CheckCircle, ExternalLink } from 'lucide-react';
        ...
        >
          <div>
            ...
            <p className="mt-2 text-center text-sm text-slate-500 dark:text-slate-400">
              Welcome back! Access your courses and personal AI tutor.
            </p>
          </div>
          ...
          <div className="space-y-3">
            <button
              ...
              className="w-full flex justify-center items-center gap-2.5 rounded-xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 py-3 px-4 text-sm font-semibold text-slate-700 dark:text-slate-200 shadow-sm hover:bg-slate-50 dark:hover:bg-slate-800/60 focus:outline-none transition-all hover:scale-[1.01]"
            >
              ...
              {effectiveClientId ? 'Sign in with Google' : 'Configure Google Sign In'}
            </button>
          ...
          <div className="text-center text-xs text-slate-500 mt-6 border-t border-slate-100 dark:border-slate-800 pt-4">
            New to EduVerse?{' '}
            <Link href="/register" className="font-bold text-indigo-600 hover:text-indigo-500 dark:text-indigo-400 dark:hover:text-indigo-300">
              Create Account
            </Link>
          </div>
        </motion.div>
